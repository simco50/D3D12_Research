...
{
public:
	static bool CompileDxc(const char* pIdentifier, const char* pShaderSource, uint32 shaderSourceSize, struct IDxcBlob** pOutput, const char* pEntryPoint = "", const char* pTarget = "", const std::vector<std::string>& defines = {});
