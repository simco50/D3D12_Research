...
std::unique_ptr<SubMesh> Mesh::LoadMesh(aiMesh* pMesh, Graphics* pGraphics, CommandContext* pContext)
{
...

	{
		...
		pSubMesh->m_pVertexBuffer->Create(pGraphics, BufferDesc::VertexBuffer((uint32)vertices.size(), sizeof(Vertex)));
...

	{
		...
		pSubMesh->m_pIndexBuffer->Create(pGraphics, BufferDesc::IndexBuffer(size));
