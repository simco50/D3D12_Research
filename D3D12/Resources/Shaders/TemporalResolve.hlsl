...
void CSMain(CS_INPUT input)
{
    ...
    neighborhood[0] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(-1, -1), 0).rgb;
    neighborhood[1] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(0, -1), 0).rgb;
    neighborhood[2] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(1, -1), 0).rgb;
    neighborhood[3] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(-1, 0), 0).rgb;
    neighborhood[4] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(0, 0), 0).rgb;
    neighborhood[5] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(1, 0), 0).rgb;
    neighborhood[6] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(-1, 1), 0).rgb;
    neighborhood[7] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(0, 1), 0).rgb;
    neighborhood[8] = tCurrentColor.SampleLevel(sPointSampler, texCoord + dxdy * float2(1, 1), 0).rgb;
    ...
    float2 velocity = tVelocity.SampleLevel(sPointSampler, texCoord, 0).rg * cInvScreenDimensions;
    texCoord -= velocity;
