...
void CSMain(CS_INPUT input)
{
	...
	float3 normal = NormalFromDepth(tDepthTexture, sLinearClamp, uv, dimInv, cData.ProjectionInverse);
	float3 viewPos = ViewFromDepth(uv.xy, depth, cData.ProjectionInverse).xyz;
